    ...
    internal class KernelMethod
    {
        ...
        static KernelMethod()
        {
            methods = new KernelMethod[]
            {
                ...
                new KernelMethod("Ceil", new Function(new Type[]{ KERNEL_TYPE.REAL }, KERNEL_TYPE.REAL)),
                ...
                new KernelMethod("Floor", new Function(new Type[]{ KERNEL_TYPE.REAL }, KERNEL_TYPE.REAL)),
                ...
                new KernelMethod("Round", new Function(new Type[]{ KERNEL_TYPE.REAL }, KERNEL_TYPE.REAL)),
                new KernelMethod("Sign", new Function(new Type[]{ KERNEL_TYPE.REAL }, KERNEL_TYPE.REAL)),
