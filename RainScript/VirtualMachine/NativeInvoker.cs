...
namespace RainScript.VirtualMachine
{
    internal unsafe class NativeInvoker
    {
        ...
        private static readonly System.Reflection.MethodInfo method_IEntityManipulator_Add = typeof(EntityManipulator).GetMethod("Add");
        private static readonly System.Reflection.MethodInfo method_IEntityManipulator_Get = typeof(EntityManipulator).GetMethod("Get");
        private static readonly System.Reflection.MethodInfo method_IEntityManipulator_Reference = typeof(EntityManipulator).GetMethod("Reference");
        private static readonly System.Reflection.MethodInfo method_IEntityManipulator_Release = typeof(EntityManipulator).GetMethod("Release");
        ...
        private static readonly System.Type[] parameters = new System.Type[] { typeof(Kernel), typeof(IPerformer), typeof(byte*), typeof(uint), typeof(uint) };
        internal delegate void NativeInvoke(Kernel kernel, IPerformer performer, byte* stack, uint bottom, uint top);
        ...
        public NativeInvoker(string name, FunctionInfo function, IPerformer performer)
        {
            ...
            var dynamicMethod = new DynamicMethod(name, typeof(void), parameters, true);
        ...
        {
            int pidx = Frame.SIZE;
            var parameterPoint = generator.DeclareLocal(typeof(byte*));
            generator.Emit(Ldarg_2);
            generator.Emit(Ldarg_S, (byte)4);
            generator.Emit(Conv_U);
            generator.Emit(Add);
            generator.Emit(Stloc, parameterPoint);
            ...
            if (retType != typeof(void))
            {
                ...
                if (retType == typeof(string))
                {
                    ...
                    generator.Emit(Ldloc, returnPoint);
                    generator.Emit(Ldind_U4);
                    generator.Emit(Call, method_StringAgency_Release);
                    generator.Emit(Ldarg_0);
                    generator.Emit(Ldfld, field_Kernel_stringAgency);
                }
                else if (retType == typeof(object))
                {
                    ...
                    generator.Emit(Callvirt, method_IEntityManipulator_Release);
                    generator.Emit(Ldarg_0);
                    generator.Emit(Ldfld, field_kernel_manipulator);
                }
            }
            ...
            foreach (var parameter in method.GetParameters())
            {
                ...
                if (type == typeof(bool))
                {
                    generator.Emit(Ldloc, parameterPoint);
                ...
                else if (type == typeof(string))
                {
                    ...
                    generator.Emit(Add);
                    generator.Emit(Ldind_U4);
                    generator.Emit(Call, method_StringAgency_Get);
                ...
                else if (type == typeof(object))
                {
                    ...
                    generator.Emit(Add);
                    generator.Emit(Ldobj, typeof(Entity));
                    generator.Emit(Call, method_IEntityManipulator_Get);
                    ...
                    generator.Emit(Add);
                    generator.Emit(Ldobj, typeof(Entity));
                    generator.Emit(Call, method_IEntityManipulator_Release);
            ...
            {
                generator.Emit(Call, method_StringAgency_Add);
                ...
                generator.Emit(Ldloc, returnPoint);
                generator.Emit(Ldind_U4);
                generator.Emit(Call, method_StringAgency_Reference);
            }
            else if (retType == typeof(object))
            {
                generator.Emit(Callvirt, method_IEntityManipulator_Add);
                ...
                generator.Emit(Ldloc, returnPoint);
                generator.Emit(Ldobj, typeof(Entity));
                generator.Emit(Callvirt, method_IEntityManipulator_Reference);
            }
